...
scRNA4SeJegroup2<-  factor(c(rep('Je', length(rownames(scRNA4@meta.data[scRNA4@meta.data$orig.ident=='Je',]))),rep('Se', length(rownames(scRNA4@meta.data[scRNA4@meta.data$orig.ident=='Se',])))))
