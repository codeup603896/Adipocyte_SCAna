...
## locale:
LC_CTYPE=zh_CN.UTF-8	LC_NUMERIC=C	LC_TIME=zh_CN.UTF-8	LC_COLLATE=zh_CN.UTF-8	LC_MONETARY=zh_CN.UTF-8	LC_MESSAGES=zh_CN.UTF-8	LC_PAPER=zh_CN.UTF-8	LC_NAME=C	LC_ADDRESS=C	LC_TELEPHONE=C	LC_MEASUREMENT=zh_CN.UTF-8 LC_IDENTIFICATION=C	
time zone: Asia/Shanghai
tzcode source: system (glibc)
attached base packages:stats graphics grDevices utils datasets methods base 

## other attached packages:
CellChat_1.6.1	Biobase_2.62.0	BiocGenerics_0.48.1	igraph_2.1.4	ggrepel_0.9.6	readxl_1.4.5	edgeR_4.0.16	limma_3.58.1	dplyr_1.1.4	openxlsx_4.2.8	AUCell_1.24.0	ggplot2_3.5.2	future_1.67.0 	Seurat_4.4.0	harmony_1.2.3	Rcpp_1.1.0 SeuratObject_4.1.4 sp_2.2-0

## loaded via a namespace (and not attached):
matrixStats_1.5.0	spatstat.sparse_3.1-0	bitops_1.0-9	httr_1.4.7 	
RColorBrewer_1.1-3	doParallel_1.0.17	tools_4.3.2	sctransform_0.4.2	
backports_1.5.0	R6_2.6.1	lazyeval_0.2.2	uwot_0.2.3	GetoptLong_1.0.5	withr_3.0.2	gridExtra_2.3	progressr_0.15.1	cli_3.6.5	textshaping_0.3.7	spatstat.explore_3.5-2	network_1.19.0	labeling_0.4.3	spatstat.data_3.1-8	ggridges_0.5.7	pbapply_1.7-4	systemfonts_1.2.3	svglite_2.2.1	R.utils_2.13.0	parallelly_1.45.1	RSQLite_2.4.3	FNN_1.1.4.1	generics_0.1.4	shape_1.4.6.1	ica_1.0-3	spatstat.random_3.4-1	car_3.1-3	zip_2.3.3	Matrix_1.6-5	S4Vectors_0.40.2	abind_1.4-5	R.methodsS3_1.8.2	lifecycle_1.0.4	carData_3.0-5	SummarizedExperiment_1.32.0	SparseArray_1.2.2	Rtsne_0.17	grid_4.3.2	blob_1.2.4	promises_1.3.3	crayon_1.5.3	miniUI_0.1.2	lattice_0.22-7	cowplot_1.2.0	annotate_1.80.0	KEGGREST_1.42.0	sna_2.8	pillar_1.11.0	ComplexHeatmap_2.18.0	GenomicRanges_1.54.1	rjson_0.2.23	future.apply_1.20.0	codetools_0.2-20	leiden_0.4.3.1	glue_1.8.0	spatstat.univar_3.1-4	data.table_1.17.8	vctrs_0.6.5	png_0.1-8	cellranger_1.1.0	gtable_0.3.6	cachem_1.1.0	S4Arrays_1.2.0	mime_0.13	coda_0.19-4.1	survival_3.8-3	iterators_1.0.14	statmod_1.5.0	fitdistrplus_1.2-4	ROCR_1.0-11	nlme_3.1-168	bit64_4.6.0-1	RcppAnnoy_0.0.22	GenomeInfoDb_1.38.8	irlba_2.3.5.1	KernSmooth_2.23-26	colorspace_2.1-1	DBI_1.2.3	tidyselect_1.2.1	bit_4.6.0	compiler_4.3.2	graph_1.80.0	BiocNeighbors_1.20.2	DelayedArray_0.28.0	plotly_4.11.0	scales_1.4.0	lmtest_0.9-40	NMF_0.28	stringr_1.5.1	digest_0.6.37	goftest_1.2-3	spatstat.utils_3.1-5	XVector_0.42.0	RhpcBLASctl_0.23-42	htmltools_0.5.8.1	pkgconfig_2.0.3	sparseMatrixStats_1.14.0	MatrixGenerics_1.14.0	fastmap_1.2.0	rlang_1.1.6	GlobalOptions_0.1.2	htmlwidgets_1.6.4	shiny_1.11.1	DelayedMatrixStats_1.24.0	farver_2.1.2	zoo_1.8-14	jsonlite_2.0.0	BiocParallel_1.36.0	statnet.common_4.12.0	R.oo_1.27.1	RCurl_1.98-1.17	magrittr_2.0.3	Formula_1.2-5	GenomeInfoDbData_1.2.11	ggnetwork_0.5.13	patchwork_1.3.2	reticulate_1.43.0	stringi_1.8.7	ggalluvial_0.12.5	zlibbioc_1.48.0	MASS_7.3-60	plyr_1.8.9	parallel_4.3.2	listenv_0.9.1	forcats_1.0.0	deldir_2.0-4	Biostrings_2.70.3	splines_4.3.2	tensor_1.5.1	circlize_0.4.16	locfit_1.5-9.12	ggpubr_0.6.1	spatstat.geom_3.5-0	ggsignif_0.6.4	rngtools_1.5.2	reshape2_1.4.4	stats4_4.3.2	XML_3.99-0.19	BiocManager_1.30.26	foreach_1.5.2	httpuv_1.6.16	RANN_2.6.2	tidyr_1.3.1	purrr_1.1.0	polyclip_1.10-7	clue_0.3-66	scattermore_1.2	gridBase_0.4-7	broom_1.0.9	xtable_1.8-4	RSpectra_0.16-2	rstatix_0.7.2	later_1.4.4	viridisLite_0.4.2	ragg_1.4.0	tibble_3.3.0	memoise_2.0.1	AnnotationDbi_1.64.1	registry_0.5-1	IRanges_2.36.0	cluster_2.1.8.1	globals_0.18.0	GSEABase_1.64.0
...
The 8 Clusters of adipocyte Cells Subset of adipose tissue were determined by the package "Seurat" in R using the following parameters: FindClusters(Data,save.SNN=T,resolution=0.3)
